...
$adminTitle = 'Blog tags'; $currentAdminPage = 'tags'; require __DIR__ . '/_header.php';
?>
<header class="admin-title"><div><p class="kicker">Blog organization</p><h1>Custom tags</h1><p>Create reusable topics for reflections. Add more than one to a post with commas, then use them to connect related writing.</p></div><a class="button button-outline" href="<?= url('admin/posts.php') ?>">Back to blog</a></header>
