...
$posts=$legacy
 ...
 :$db->query('SELECT id,title,slug,category,status,published_at FROM wts_posts ORDER BY published_at DESC,created_at DESC')->fetchAll();$adminTitle='Journal';$currentAdminPage='posts';require __DIR__.'/_header.php';
?>
