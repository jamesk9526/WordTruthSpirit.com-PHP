...
$sourceLabels = ['journal-panel'=>'Blog panel','reflection-end'=>'Reflection ending','footer'=>'Website footer','bottom-banner'=>'Bottom banner','php-blog'=>'Blog','website'=>'Website'];
...
?>
<header class="admin-title"><div><p class="kicker">Reader growth</p><h1>Subscribers</h1><p>People who asked to receive new blog reflections and ministry updates.</p></div></header>
